...
from interview_detection import config
from interview_detection.models.predict import predict
from interview_detection.response_handler import APIResponseHandler

ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg', 'pdf', 'xlsx'}

app = Flask('Interview Detection')
app.config['UPLOAD_FOLDER'] = config.DATA_FOLDER
router = '/interview-detection/' + config.ENV
...
def hello():
    return 'Hello from Interview Detection!'
